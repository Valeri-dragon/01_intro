...
/*
Определение сортировки в массиве
Сортировка массива — это изменение порядка элементов массива по правилу. 
Это один из важнейших базовых алгоритмов в программировании. 
Сортировка облегчает поиск по массиву и ускоряет работу программы,
 помогает показывать пользователю товары в отсортированном виде по цене, 
 весу, скорости доставки и другим параметрам. Сортировка — это порядок в массиве и программе.
Один из простых методов сортировки — метод «пузырька».
В JS есть встроенные функции сортировки,
 но для практики обработки массивов 
 выполнена сортировка без использования готовых функций от меньшего к большему по методу "пузырька".
 */
let arrNumber = [3, 22, 34, 12, 55, 22, 12, 3];

for (let i = 0; i < arrNumber.length; i++) {
    for (let j = 0; j < arrNumber.length - 1; j++){
        l(`A: ${arrNumber[j]}, B: ${arrNumber[j+1]}`)
        //если изменить знак с > на <
        // то сортировка будет работать в др. направлении
